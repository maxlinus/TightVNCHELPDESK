...
#AutoIt3Wrapper_Outfile=helpdesk_ls.exe
...
Global Const $GUI_NAME = 'HELPDESK v0.31'
...
; Create the GUI.
$InstantSupport = GUICreate( $GUI_TITLE, 450, 280, -1, -1, BitOR( $WS_SYSMENU,$WS_CAPTION,$WS_POPUP,$WS_POPUPWINDOW,$WS_BORDER,$WS_CLIPSIBLINGS,$WS_MINIMIZEBOX ) )
...
;~ $MenuItem9 = GUICtrlCreateMenu("Служба", $MenuItem1)
$MenuItem13 = GUICtrlCreateMenuItem("Установить mirror display driver", $MenuItem1)
;~ $MenuItem14 = GUICtrlCreateMenuItem("RDP", $MenuItem1)
$MenuItem12 = GUICtrlCreateMenuItem("Пробросить порт", $MenuItem1)

;~ $MenuItem8 = GUICtrlCreateMenuItem("Установить службу", $MenuItem9)
;~ $MenuItem10 = GUICtrlCreateMenuItem("Удалить службу", $MenuItem9)

$empty1 = GUICtrlCreateMenuItem("", $MenuItem1)
$MenuItem5 = GUICtrlCreateMenuItem("Выйти", $MenuItem1)

$MenuItem2 = GUICtrlCreateMenu("Справка")
;~ $MenuItem6 = GUICtrlCreateMenuItem("Наши контакты", $MenuItem2)
...
;~ $Label3 = GUICtrlCreateLabel( "ПАРОЛЬ", 0, 190, 450, 100, $SS_CENTER )
;~ GUICtrlSetFont( -1, 16, 300, 0, "Arial Black" )
;~ $Label2 = GUICtrlCreateLabel( $PWNumber, 0, 220, 450, 100, $SS_CENTER )
;~ GUICtrlSetFont( -1, 50, 800, 0, "Arial Black" )
